...
const host_1 = __webpack_require__(38);
...
const Key_1 = __webpack_require__(4);
...
class Client {
  ...
  to a major version mismatch between client and host iframe-coordinator libraries.
        ...
        this._onKeyDown = (event) => {
            ...
            const shouldSend = this._registeredKeys.some((key) => Key_1.keyEqual(key, event));
            if (!shouldSend) {
                return;
            }
            this._sendToHost({
    ...
    _handleEnvironmentData(message) {
        const envInitMsg = message;
        const _a = envInitMsg.msg, { assignedRoute } = _a, envData = __rest(_a, ["assignedRoute"]);
     ...
     */
    asHostUrl(clientRoute) {
        const trimedClientRoute = urlUtils_1.stripLeadingSlashAndHashTag(clientRoute);
        return urlUtils_1.joinRoutes(this.environmentData.hostRootUrl, this._assignedRoute || '', trimedClientRoute);
    }
    _sendToHost(partialMsg) {
        const message = LabeledMsg_1.applyClientProtocol(partialMsg);
        let validated;
        try {
...
Object.defineProperty(exports, "__esModule", { value: true });
const codeMap = new Map(Object.entries({
    Comma: ',',
    Period: '.',
    Semicolon: ';',
    Quote: '"',
